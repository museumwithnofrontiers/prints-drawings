...
The **Museum With No Frontiers — Prints and Drawings** gallery, built from the published
dataset `@museumwnf/prints-drawings-data`.
...
| Package | Role |
| --- | --- |
| `@museumwnf/prints-drawings-data` | the dataset (JSON + `manifest.json`) |
...
<https://museumwithnofrontiers.github.io/prints-drawings/> through the reusable workflows in
