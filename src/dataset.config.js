...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'Prints and drawings',
  ...
  // one entry for every project id `npm pack @museumwnf/prints-drawings-data`
  // carries in `manifest.projects` (checked 2026-09-19, prints-drawings-data 1.0.9).
  ...
  site: { origin: 'https://museumwithnofrontiers.github.io/prints-drawings' },
