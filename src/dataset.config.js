...
const about = {
  body: 'printsDrawings.about.body',
...
export default {
  ...
  home: {
    title: 'printsDrawings.identity.title',
    intro: 'printsDrawings.home.intro',
    cards: [
      {
        title: 'printsDrawings.nav.catalogue',
        description: 'printsDrawings.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'printsDrawings.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'printsDrawings.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'printsDrawings.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //
  //   extraViews: [
  //     ...standardRoutes('gallery', { creditsBody: 'printsDrawings.credits.body' }),
  ...
  //       partnerObjects: {
  //         emptyPartner: 'printsDrawings.partnerObjects.emptyPartner',
  //         emptyInstitution: 'printsDrawings.partnerObjects.emptyInstitution',
  //         institutionSummary: 'printsDrawings.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'printsDrawings.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'printsDrawings.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
