...
// `useGalleryData.js` used to be byte-identical local copies of what prints-drawings
...
// legacy project key, no UUID — prints-drawings shares the same entity list and
...
export const itemSheet = {
  ...
  related: {
    ...
    // Since inventory-app#1807 (prints-drawings-data 1.0.11+), an outside
